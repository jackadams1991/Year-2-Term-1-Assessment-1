...
public abstract class Rental {
    ...
    public Rental(String idOfRental,double pricePerWeek, String detailsOfAddress, String descOfRental, int isFurnished)
    {
        rentalId = idOfRental;
    ...
    public void setRentalFurnished(int furnished)
    {
